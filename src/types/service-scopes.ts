...
// ~ ======= Module Names ======= ~
export type ModuleName = "staff" | "school";

// ~ ======= Provider Names ======= ~
export type ProviderName = "provider:stripe";

// ~ ======= Combined Service Scope ======= ~
export type ServiceScope = ModuleName | ProviderName;

// ~ ======= Module Registry (for runtime validation) ======= ~
export const MODULES: readonly ModuleName[] = ["staff", "school"] as const;

// ~ ======= Provider Registry (for runtime validation) ======= ~
export const PROVIDERS: readonly ProviderName[] = ["provider:stripe"] as const;
